...
const base =
  'inline-flex items-center justify-center gap-2 rounded-full px-5 h-12 sm:h-10 text-14 font-medium ' +
...
const variants: Record<Variant, string> = {
  ...
  primary:
    'bg-bulb-500 text-glass-900 hover:brightness-105 disabled:bg-glass-200 disabled:text-glass-400',
  secondary:
    'bg-glass-200 text-glass-900 hover:bg-glass-400 disabled:text-glass-400 disabled:bg-glass-200',
  ghost:
    'bg-transparent text-glass-600 hover:text-glass-900 disabled:text-glass-400',
  danger:
    'bg-transparent text-alarm-700 border border-glass-200 hover:bg-glass-100 disabled:text-glass-400'
}
...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(function IconButton(
  ...
  return (
    <motion.button
      ...
      transition={{ duration: 0.09, ease: [0.22, 1, 0.36, 1] }}
      className={
        'inline-flex h-12 w-12 sm:h-10 sm:w-10 items-center justify-center rounded-full transition-colors no-drag ' +
